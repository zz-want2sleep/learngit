...
<html>
  ...
  <body bgcolor="white">
	 <table bgcolor="#F0F8FC" width="800" height="100%" align="center" cellspacing="0" border="1">
	   ...
	   <tr><td height="4%">
	        <font face="webdings" color="#FF3300">1</font> <a href="ManagerListProjectServlet?method=listProject" ><font size="2" color="black">项目管理</font></a>
	        <font face="webdings" color="#FF3300">2</font><a href="ManagerListUserServlet"><font size="2" color="black">用户管理</font></a>
			...
			<font face="webdings" color="#FF3300">4</font><a href="用户登录.jsp" target="_self"><font size="2" color="black">重新登录</font></a>
...
<table width="800" height="244" border="1" align="center" cellpadding="0" cellspacing="0"  bgcolor="d5effe">
  <tr ><th height="47" colspan="9" align="center">项目浏览</th></tr>
  <tr>
    ...
    <td width="10%" align="center">停止</td>
  </tr>
  ...
  <tr>
    ...
    <td><a href="ManagerListVoterServlet?method=view&proName=${project.proName}">查看项目</a></td>
    <td><a href="ManagerListProjectServlet?method=stopProject&proName=${project.proName}">停止项目</a></td>  </tr>  </c:forEach>
</table>
<a href="ManagerHistoryProject?method=managerListHistoryProject">历史项目</a>
           <a href="add.jsp">新建项目</a> </td></tr>
